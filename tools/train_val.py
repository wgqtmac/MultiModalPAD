...
def train_src(model, train_loader, val_loader):
...
def eval_src(model, data_loader):
    ...
    for (image1, image2, image3) in data_loader:
        ...
        # print("{} {} {} {%-.6f} {%-.6f} {%-.6f}".format(img1_name, img2_name, img3_name,
        #                                                 round(probability1_value[0], 6),
        #                                                 round(probability2_value[0], 6),
        #                                                 round(probability3_value[0], 6)))
